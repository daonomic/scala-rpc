...
object Dependencies {
  ...
  val reactor = "io.projectreactor" % "reactor-core" % "3.1.8.RELEASE"
  val reactorNetty = "io.projectreactor.ipc" % "reactor-netty" % "0.7.8.RELEASE"
  val cats = "org.typelevel" %% "cats-core" % "1.2.0"
  val springWebFlux = "org.springframework" % "spring-webflux" % "5.0.8.RELEASE"
